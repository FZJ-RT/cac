...
To provide training samples for constructing machine learning models, we frequenly use Lattice-Boltzmann method. The Lattice-Boltzmann code can be donwloaded through this link: [lbm](git@github.com:FZJ-RT/lbm.git) that should be used in conjuction with `cac`. 
